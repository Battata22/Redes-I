...
public class LifeBarManager2 : MonoBehaviour
{
    public static LifeBarManager2 Instance;

    [SerializeField] LifeBar2 _lifeBarPrefab;

    //Coleccion con todas las barras de vida en juego
    List<LifeBar2> _lifeBarsInUse;

    private void Awake()
    {
        Instance = this;

        _lifeBarsInUse = new List<LifeBar2>();
    }


    public void CreateNewBar(PlayerBehaviour2 owner)
    {
        //Crear la barra
